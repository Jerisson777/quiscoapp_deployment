...
//Esta funcion hace o muestra la informacion de los productos al hacer click en un modal que proviene de nextJS
const ModalProducto = () => {
    ...
    useEffect(() => {
        //comprobar si la informacion del modal actual es la del producto seleccionado
        if(pedido.some(pedidoState => pedidoState.id === producto.id)){
            
            const productoEdit = pedido.find((pedidoState) => pedidoState.id === producto.id)
            setEdicion(true)
